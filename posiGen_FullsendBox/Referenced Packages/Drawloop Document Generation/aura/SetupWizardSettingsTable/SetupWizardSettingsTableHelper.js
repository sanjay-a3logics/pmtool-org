({
    ...
    replaceSpinnersWithLinks : function(component) {
        var spinners = document.getElementsByClassName('slds-spinner');
        for (var i = 0; i < spinners.length; i++) {
            if (spinners[i].style.display != 'none') {
                spinners[i].style.display = 'none';
            }
            spinners[i].previousSibling.firstChild.style.display = 'inline-block';
        }
    }
})